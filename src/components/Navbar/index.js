        ...
        <div className='navbar-section'>
            <div className='navbar-section__content'>
                ...
                <div className='navbar-section__menu-nav'>
                    <Link className='navbar-section__item' activeClass='active' to='about' spy={true} smooth={true} duration={800}>
                        <a href="about" className='navbar-section__links'>About Us</a>
                    </Link>
                    <Link className='navbar-section__item' activeClass='active' to='services' spy={true} smooth={true} duration={800}>
